...
module.exports = {
    ...
    getQueue(body, _cb) {
        ...
        const path = '/api/queues/' + encodeURIComponent(body.vhost) + '/' + encodeURIComponent(body.queue)
        this.client.get(path, _cb)
    },
    ...
    getQueueBindings(body, _cb) {
        ...
        const path = `/api/queues/${encodeURIComponent(body.vhost)}/${encodeURIComponent(body.queue)}/bindings`
        this.client.get(path, _cb)
    },
    /**
    ...
    purgeQueue(body, _cb) {
        ...
        const path = `/api/queues/${encodeURIComponent(body.vhost)}/${encodeURIComponent(body.queue)}/contents`
        this.client.delete(path, _cb)
    },
    ...
    setQueueActions(body, _cb) {
        ...
        if (!body.action) {
            _cb(null, { errorMessage : 'Action is missing' })
            return
        }
        const path = `/api/queues/${encodeURIComponent(body.vhost)}/${encodeURIComponent(body.queue)}/actions`
